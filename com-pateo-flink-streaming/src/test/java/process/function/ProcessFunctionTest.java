...
public class ProcessFunctionTest {
	 ...
	 */
	public static class CountWithTimeoutFunction extends RichProcessFunction<Tuple2<String, String>, Tuple2<String, Long>> implements ProcessFunction<Tuple2<String, String>, Tuple2<String, Long>> {
...
//                .sum(1);
		...
		DataStream<Tuple2<String, String>> stream = env.fromElements(t1,t2,t3,t4);
