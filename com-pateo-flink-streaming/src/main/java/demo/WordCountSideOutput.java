...
public class WordCountSideOutput {
	/**
	 * We need to create an { OutputTag} so that we can reference it when
	 * emitting data to a side output and also to retrieve the side output
	 * stream from an operation.
	 */
	private static final OutputTag<String> rejectedWordsTag = new OutputTag<String>(
			"rejected") {
	...
	public static void main(String[] args) throws Exception {
		...
		DataStream<String> rejectedWords = tokenized.getSideOutput(
				rejectedWordsTag).map(new MapFunction<String, String>() {
			private static final long serialVersionUID = 1L;
		...
		DataStream<Tuple2<String, Integer>> counts = tokenized.keyBy(0)
	...
	public static final class Tokenizer extends
			ProcessFunction<String, Tuple2<String, Integer>> {
		private static final long serialVersionUID = 1L;
