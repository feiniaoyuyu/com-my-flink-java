...
public class SocketWindowWordCount {
	...
	public static void main(String[] args) throws Exception {
		...
		DataStream<String> text = env.socketTextStream("10.172.10.167", port, "\n");

		SingleOutputStreamOperator<WordWithCount> flatMap = text
		...
		flatMap.addSink(new SinkFunction<SocketWindowWordCount.WordWithCount>() {
		...
		KeyedStream<WordWithCount, Tuple> keyBy = text
