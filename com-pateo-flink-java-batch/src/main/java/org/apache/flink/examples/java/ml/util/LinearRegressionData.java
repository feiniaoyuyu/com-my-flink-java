...
public class LinearRegressionData {
	...
	public static final Object[][] DATA = new Object[][] {
			...
			new Object[] { -0.08, -0.16 },
			new Object[] { 0.13, 0.26 },
			new Object[] { -1.17, -2.35 },
			new Object[] { 1.72, 3.45 }, 
			new Object[] { 1.70, 3.41 },
			new Object[] { 1.20, 2.41 }, 
			new Object[] { -0.59, -1.18 },
			new Object[] { 0.28, 0.57 }, 
			new Object[] { 1.65, 3.30 },
