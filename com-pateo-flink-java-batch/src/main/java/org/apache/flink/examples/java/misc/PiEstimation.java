...
public class PiEstimation implements java.io.Serializable {
	...
	public static void main(String[] args) throws Exception {
		...
		//final ExecutionEnvironment env = ExecutionEnvironment.createRemoteEnvironment("10.172.10.168", 8081, "D:/javascalaspace/com-pateo-flink/com-pateo-flink-java/target/com-pateo-flink-java-1.0.jar");
