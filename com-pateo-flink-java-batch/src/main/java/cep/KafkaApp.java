...
public class KafkaApp {
	public static void main(String[] args) throws Exception {
		...
		DataStream<TemperatureEvent> inputEventStream = env
				.addSource(new FlinkKafkaConsumer08<TemperatureEvent>("test", new EventDeserializationSchema(), properties));
		...
		DataStream<Alert> patternStream = CEP
				.pattern(inputEventStream, warningPattern)
