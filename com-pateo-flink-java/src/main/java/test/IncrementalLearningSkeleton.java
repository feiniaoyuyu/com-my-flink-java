...
public class IncrementalLearningSkeleton {
	...
	public static void main(String[] args) throws Exception {
		...
		//trainingData.assignTimestampsAndWatermarks()
		...
		// emit result
		if (fileOutput) {
			prediction.writeAsText(outputPath, WriteMode.OVERWRITE);
		} else {
			prediction.print();
		}
	...
	private static String outputPath = "/com-pateo-flink-java/checkpoint";
